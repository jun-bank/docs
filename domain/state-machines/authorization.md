...
| T10 | `CAPTURED` | `refund`(전액) | `REFUNDED` | INV-1 · **INV-7 (`환불 누계 ≤ withdrawnAmount`)** | **역분개** · 자금 반환 · **대응 미수 소멸** · 한도 복원 **없음** | BR-24·26·**43 ①** |
...
| 현재 \ 조작 | `authorize` | `createVoided` | `decline` | `reverse` | `void` | `expire` | `capture` | `refund` | `markSettled` | `freeze` | `unfreeze` |
|---|---|---|---|---|---|---|---|---|---|---|---|
| **`REQUESTED`** | O (T1) | **O** (T3) | O (T2) | - | - | - | - | - | - | - | - |
| **`AUTHORIZED`** | X (F8) | X (F8) | X (F19) | **O** (T4) | **O** (T5·T6) | **O** (T7) | **O/X** (T8 / F15) | ▲ (F7) | X (F20) | O (T14) | O (T14) |
| **`EXPIRED`** | X (F8) | X (F8) | X (F19) | **O** (T13) | **O** (T13) | ◎ | **O/X** (T9 / F15) | ▲ (F7) | X (F20) | O (T14) | O (T14) |
