...
**다음 한 걸음**: ★ **남은 공백 3건** — ① **C7 관리 API의 UC·계약**(2026-08-06 루프 1 L1-15로 이월 확정) ② **외부 인터페이스 규격서** ③ **API 레퍼런스 생성 도구**. 이들을 닫은 뒤 **Phase 5(샘플 구현 + 실험 38건)** 로 넘어간다 — Phase 5의 입력에는 **`implementation-verification.md`(IV-1~10)** 가 포함된다(검증 정책 v2 V2-3: 문서에서 판정하지 않기로 한 항목의 공식 출구).
