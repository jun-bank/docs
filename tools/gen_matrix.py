...
ASSIGN = {
 ...
 "Authorization.freeze":"—","Authorization.unfreeze":"—","Authorization.markSettled":"—",
 ...
 "CaptureBatch.isolate":"별도","CaptureBatch.interrupt":"—","CaptureBatch.complete":"—",
 "CaptureBatch.promoteIsolated":"—",
...
NOTE = {
 ...
 "CaptureBatch.isolate":"불일치 적재는 Outbox (BR-40과 같은 이유)",
