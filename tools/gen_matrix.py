...
ASSIGN = {
 ...
 "DepositReceipt.find":"조회","DepositReceipt.record":"E3 E5",
 "DepositReceipt.assertSameRequest":"조회","DepositReceipt.expire":"—",
 "IdempotencyRecord.find":"조회","IdempotencyRecord.record":"E1",
 ...
 "Member.register":"—","Member.deactivate":"—","Member.reactivate":"—",
 "Member.requestClose":"—","Member.close":"—",
}
NOTE = {
 "CaptureBatch.reclassifyIsolated":"배치만 변경 — 불일치 적재는 Outbox (BR-50 재분류)",
 "Operator.transfer":"★ grant 자동 회수 동반 — C7 내부 원자 갱신(자금 무이동, E 표 밖 의식적 예외)",
 "Operator.terminate":"★ 전 grant 회수 동반 — 〃",
 "RoleGrant.issue":"authzVersion 증가 동반 — 〃",
 "RoleGrant.revoke":"〃","RoleGrant.recertify":"〃",
